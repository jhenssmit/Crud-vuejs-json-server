    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class=" fst-italic text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio tempore quaerat, accusamus, quis velit laborum at molestias soluta dolore vel dolorem. Quos consectetur, dignissimos odit necessitatibus eius facilis corporis unde.</p>
            </div>
        </div>
    </div>
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-4">
                <form @submit.prevent="submitCreate()">
                    ...
                    <div class="mb-2">
                        <input type="submit" class=" form btn btn-success" value="Create">
                    </div>
                </form>
            </div>
            <div class="col-md-4">
